...
let pf_first_secrnd  pe st = pf_first_gen  "secrnd"  destr_secrnd  pe st
...
let pf_last_secrnd  pe st = pf_last_gen  "secrnd"  destr_secrnd  pe st
...
let tc1_first_secrnd  tc st = pf_first_secrnd  !!tc st
...
let tc1_last_secrnd  tc st = pf_last_secrnd  !!tc st
...
let pf_pos_last_secrnd  pe s = pf_pos_last_gen "secrnd"  is_secrnd  pe s
...
let tc1_pos_last_secrnd  tc s = pf_pos_last_secrnd  !!tc s
